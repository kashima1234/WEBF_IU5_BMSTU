...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  expeditions = {
     ...
     * @secure
     */
    expeditionsUpdateStatusAdminUpdate: (
      expeditionId: string,
      data: UpdateExpeditionStatusAdmin,
      params: RequestParams = {},
    ) =>
      this.request<UpdateExpeditionStatusAdmin, any>({
  ...
  places = {
     ...
     * @secure
     */
    placesUpdateUpdate: (placeId: string, data: Place, params: RequestParams = {}) =>
